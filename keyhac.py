...
def configure(keymap):
    ...
    # author: @lyuich - Global keymap which affects any windows
    if 1:
        ...
        keymap_global[ "Ctrl-U" ] = "Cmd-Back"
        keymap_global[ "Ctrl-W" ] = "Alt-Back"
        keymap_global[ "Ctrl-OpenBracket" ] = "ESC"
        keymap_global[ "Ctrl-I" ] = "TAB"
        keymap_global[ "Ctrl-V" ] = "PageDown"
        keymap_global[ "Alt-V" ] = "PageUp"
		

    # author: @lyuich - iTerm key customization
    if 1:
        keymap_iterm = keymap.defineWindowKeymap( app_name="com.googlecode.iterm2" )
        keymap_iterm[ "Ctrl-M" ] = "Ctrl-M" 
        keymap_iterm[ "Ctrl-N" ] = "Ctrl-N"
        keymap_iterm[ "Ctrl-P" ] = "Ctrl-P"
        keymap_iterm[ "Ctrl-F" ] = "Ctrl-F"
        keymap_iterm[ "Ctrl-B" ] = "Ctrl-B"
        keymap_iterm[ "Ctrl-U" ] = "Ctrl-U"
        keymap_iterm[ "Ctrl-W" ] = "Ctrl-W"
        keymap_iterm[ "Ctrl-OpenBracket" ] = "Ctrl-OpenBracket"
        keymap_iterm[ "Ctrl-I" ] = "Ctrl-I"
        keymap_global[ "Ctrl-V" ] = "Ctrl-V"
        keymap_global[ "Alt-V" ] = "Alt-V"
    ...
    # if 1:
        # keymap_global[ "O-RCmd" ] = "Cmd-Spaces”
